...
const Footer = () => {
    return (
        <footer className="min-h-[280px] bg-orange text-[#F0F0F0]">
            <div className="flex flex-row justify-between items-start p-8 lg:flex-wrap md:gap-6 md:justify-center md:items-center">
                <div className="flex flex-col justify-center gap-8 md:items-center md:gap-4">
                    ...
                    <p className="b-0875 max-w-[500px] text-white md:text-center">Savor the Symphony of Sweetness: Dive into a World of Irresistible Cakes and Cookies, Each Baked to Perfection. Experience the True Essence of Delight and Quality Craftsmanship.</p>
                </div>
                ...
                <div className="flex flex-col justify-end items-end gap-4 md:justify-center md:items-center md:gap-2">
                    ...
                    <div className="flex flex-col justify-center items-center gap-2 font-medium leading-8 tracking-widest"><span>+99891 352 4474</span><span>+99833 052 4474</span></div>
            ...
            <div className="w-full">
                ...
                <div className="w-full flex flex-row justify-between items-center py-3 px-4 md:flex-col">
                    <h3>Copyright © 2032 all rights reserved</h3>
                    <Link href='https://github.com/nbn2000' className="underline ">Designed by <strong>Makhmudov Nodirbek</strong></Link>
                </div>
            </div>
        </footer>
    )
