      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="relative z-0 w-full mb-5 group">
          <textarea
            name="desctiption"
            id="desctiption"
            className="resize-none block py-2.5 px-0 w-full border-solid text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-[#f2360a] focus:outline-none focus:ring-0 focus:border-[#f2360a] peer"
            placeholder=" "
            cols={1}
            rows={1}
            required
