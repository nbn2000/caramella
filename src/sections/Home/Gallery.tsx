...
const Gallery = () => {
  const [mainImg, setMainImg] = useState({ id: 1, img: birthdayCake });
  ...
  const handleHover = (a: number, b: any) => {
    if (mainImg.id !== a) {
      setTransition(true);
      const timeout = setTimeout(() => {
        setTransition(false);
        setMainImg({ id: a, img: b });
  ...
  return (
    <div className="cont-y container-p">
      ...
      <div className="max-w-full mx-auto flex justify-center items-center relative">
        <div className="aspect-square w-[30%] my-[6rem] lg:w-[40%]">
          <Image
            src={mainImg.img}
            alt="hovered image"
            width={300}
        ...
        <div
          ...
          onMouseMove={() => handleHover(1, weddingCake)}
        >
        ...
        <div
          ...
          onMouseMove={() => handleHover(2, biscuits)}
        >
          <div className="relative w-full h-full">
            <Image
              src={biscuits}
        ...
        <div
          ...
          onMouseMove={() => handleHover(3, cupCake)}
        >
          <div className="relative w-full h-full">
            <Image
              src={cupCake}
        ...
        <div
          ...
          onMouseMove={() => handleHover(4, customCake)}
        >
          <div className="relative w-full h-full">
            <Image
              src={customCake}
        ...
        <div
          ...
          onMouseMove={() => handleHover(5, macarons)}
        >
          <div className="relative w-full h-full">
            <Image
              src={macarons}
        ...
        <div
          ...
          onMouseMove={() => handleHover(6, birthdayCake)}
        >
          <div className="relative w-full h-full ">
            <Image
              src={birthdayCake}
